...
TabNuke:AddSection("AVISO 🚨")
TabNuke:AddParagraph({
"Aviso do medr0so_0",
"para quem está se perguntado ''porque o skybox sumiu?'', foi porque a voldex deu patched nessa função, e só percebi agora porque fiquei um tempo sem jogar roblox"
})
